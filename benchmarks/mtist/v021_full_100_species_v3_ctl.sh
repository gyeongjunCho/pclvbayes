...
RESULT_ROOT="$REPO/benchmarks/mtist/results/v021_full_100_species_v3"
CONFIG="$REPO/benchmarks/mtist/configs/v021_full_100_species_v3.R"
RUNNER="$REPO/benchmarks/mtist/run_v021_full_100_species.R"
EXECUTABLE="$REPO/inst/stan/pclv"
LOG_DIR="$REPO/benchmarks/mtist/logs"
LOG="$LOG_DIR/v021_full_100_species_v3.nohup.log"
PIDFILE="$LOG_DIR/v021_full_100_species_v3.controller.pid"
LAUNCH_META="$LOG_DIR/v021_full_100_species_v3.launch.tsv"
...
action_restart() {
  ...
  stamp="$(date +%Y%m%d-%H%M%S)"
  restart_log="$LOG_DIR/v021_full_100_species_v3.restart.$stamp.log"
  restart_meta="$LOG_DIR/v021_full_100_species_v3.restart.$stamp.tsv"
...
action_help() {
  cat <<'EOF'
Usage:
  v021_full_100_species_v3_ctl.sh launch
  v021_full_100_species_v3_ctl.sh status
  v021_full_100_species_v3_ctl.sh tail
  v021_full_100_species_v3_ctl.sh processes
  v021_full_100_species_v3_ctl.sh affinity
  v021_full_100_species_v3_ctl.sh progress
  v021_full_100_species_v3_ctl.sh storage
  v021_full_100_species_v3_ctl.sh orphans
  v021_full_100_species_v3_ctl.sh restart
  v021_full_100_species_v3_ctl.sh restart --reconcile-stale-lock
  v021_full_100_species_v3_ctl.sh help
EOF
}
