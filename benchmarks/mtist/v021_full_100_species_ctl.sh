...
RESULT_ROOT="$REPO/benchmarks/mtist/results/v021_full_100_species_v2"
CONFIG="$REPO/benchmarks/mtist/configs/v021_full_100_species.R"
RUNNER="$REPO/benchmarks/mtist/run_v021_full_100_species.R"
EXECUTABLE="$REPO/inst/stan/pclv"
LOG_DIR="$REPO/benchmarks/mtist/logs"
LOG="$LOG_DIR/v021_full_100_species_v2.nohup.log"
...
action_restart() {
  ...
  stamp="$(date +%Y%m%d-%H%M%S)"
  restart_log="$LOG_DIR/v021_full_100_species_v2.restart.$stamp.log"
  restart_meta="$LOG_DIR/v021_full_100_species_v2.restart.$stamp.tsv"
...
action_help() {
  cat <<'EOF'
Usage:
  v021_full_100_species_ctl.sh launch
  v021_full_100_species_ctl.sh status
  v021_full_100_species_ctl.sh tail
  v021_full_100_species_ctl.sh processes
  v021_full_100_species_ctl.sh affinity
  v021_full_100_species_ctl.sh progress
  v021_full_100_species_ctl.sh storage
  v021_full_100_species_ctl.sh orphans
  v021_full_100_species_ctl.sh restart
  v021_full_100_species_ctl.sh restart --reconcile-stale-lock
